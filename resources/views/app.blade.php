		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Form Management<span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li class="dropdown dropdown-submenu"><a tabindex="-1" href="#">Duchenne</a>
								<ul class="dropdown-menu">
									<li><a href="{{ URL::asset('/duc_report') }}">Duchenne Report</a></li>
									<li><a href="{{ URL::asset('/form') }}">Duchenne Form </a></li>
								</ul>
							</li>
						</ul>
					</li>
