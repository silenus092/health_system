...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <article>
                <h1 id="headline">ICBS</h1>
                <p id="text">
                    Integrative Computational Bioscience Center We promotes multidisciplinary research. The ICBS Center aims to conduct, provide support,
                    and promote multidisciplinary research in biomedical and related fields,...</p>
            </article>
        </div>
    </div>
