...
CREATE TABLE IF NOT EXISTS `health_it2`.`disease_types` (
  `disease_type_id` INT NOT NULL AUTO_INCREMENT,
  `disease_type_name_th` VARCHAR(45) NULL,
  `disease_type_name_en` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `health_it2`.`disease_forms` (
  ...
  PRIMARY KEY (`question_id`, `disease_type_id`),
  INDEX `fk_disease_forms_disease_types1_idx` (`disease_type_id` ASC),
...
CREATE TABLE IF NOT EXISTS `health_it2`.`disease_1` (
  ...
  `symptom_10_1_number` VARCHAR(45) NULL,
  `symptom_10_1_check` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `health_it2`.`patients_disease_forms` (
  `patients_do_questions_id` INT NOT NULL AUTO_INCREMENT,
